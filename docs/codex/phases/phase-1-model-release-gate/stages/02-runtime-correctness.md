...
Add a CPU reference adapter and target runtime adapters for ONNX and TensorRT,
then compare deterministic fixture outputs under manifest tolerances. Invalid,
